...
func main() {
	...
	plotEndTimeFlag := plotCommand.String("time", "now", "Sets the end time for the plot, how many seconds before now (int)")
	...
	case "plot":
		...
		plot(*plotNodeListFlag, *plotDataDirFlag, *plotContentFlag, *plotNodeFlag, *plotOutputFlag, *plotWindowFlag, *plotDurationFlag, *plotEndTimeFlag)
	case "check":
