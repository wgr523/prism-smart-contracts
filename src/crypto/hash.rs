...
pub use ethereum_types::{H256 as EthereumH256, Address};
...
/// A SHA256 hash. Use ethereum_types::H256 instead.
...
impl std::convert::From<EthereumH256> for H256 {
    fn from(input: EthereumH256) -> H256 {
        H256(input.0)
    }
}
...
impl std::convert::From<H256> for EthereumH256 {
    fn from(input: H256) -> EthereumH256 {
        EthereumH256(input.0)
    }
}
...
pub mod tests {
    ...
    fn hash() {
        ...
        let should_be: [u8; 32] =
            hex!("9cecaaf9d3dea95ee3d1ec48286615308767ee34d5b47396b1743f751d8d6684");
